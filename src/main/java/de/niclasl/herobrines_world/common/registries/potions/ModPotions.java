package de.niclasl.herobrines_world.common.registries.potions;
...
public class ModPotions {
	public static final DeferredRegister<Potion> POTIONS = DeferredRegister.create(Registries.POTION, HerobrinesWorld.MOD_ID);
