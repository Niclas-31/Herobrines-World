package de.niclasl.herobrines_world.common.registries.enchantment.custom;
...
public record HeartOfTheForestEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<HeartOfTheForestEffect> CODEC = MapCodec.unit(HeartOfTheForestEffect::new);
