package de.niclasl.herobrines_world.registries.block.entity.renderer;
...
public class LogicGateBlockEntityRenderer implements BlockEntityRenderer<LogicGateBlockEntity, LogicGateBlockEntityRenderState> {
    ...
    @Override
    public @NotNull LogicGateBlockEntityRenderState createRenderState() {
        return new LogicGateBlockEntityRenderState();
    }

    @Override
    public void extractRenderState(@NotNull LogicGateBlockEntity entity, @NotNull LogicGateBlockEntityRenderState state,
        ...
        state.saved = entity.getMode().getSymbol();
    }

    @Override
    public void submit(@NotNull LogicGateBlockEntityRenderState state, @NotNull PoseStack poseStack,
