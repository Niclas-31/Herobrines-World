package de.niclasl.herobrines_world.registries.entity.renderer.custom;

import de.niclasl.herobrines_world.registries.entity.custom.Niclasl;
...
public class NiclaslRenderer extends HumanoidMobRenderer<Niclasl, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
    ...
    public @NotNull Identifier getTextureLocation(@NotNull HumanoidRenderState state) {
        return Identifier.parse("herobrines_world:textures/entity/niclasl.png");
    }
}