...
public class ToxeniumShovel extends ShovelItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(
			...
			TagKey.create(
					Registries.ITEM,
					ResourceLocation.parse("herobrines_world:toxenium_shovel_repair_items")));

	public ToxeniumShovel(Item.Properties properties) {
		super(TOOL_MATERIAL, 2f, -2.6f, properties.fireResistant());
	}
