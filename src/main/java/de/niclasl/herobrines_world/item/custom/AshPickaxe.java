...
public class AshPickaxe extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 1500, 9f, 0, 15, TagKey.create(Registries.ITEM, Identifier.parse("herobrines_world:ash_pickaxe_repair_items")));
