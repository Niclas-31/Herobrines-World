...
public class ToxeniumAxe extends AxeItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(
			...
			TagKey.create(
					Registries.ITEM,
					ResourceLocation.parse("herobrines_world:toxenium_axe_repair_items")));

	public ToxeniumAxe(Item.Properties properties) {
		super(TOOL_MATERIAL, 22f, -2.6f, properties.fireResistant());
	}
